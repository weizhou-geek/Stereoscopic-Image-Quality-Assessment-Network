...
X_testLeft = np.load('./test_image_left_LIVE1.npy')
X_testRight = np.load('./test_image_right_LIVE1.npy')
...
model_all.load_weights('./LIVE1_model_200.hdf5')
y_predict = model_all.predict([X_testLeft, X_testRight], batch_size=10)
sio.savemat('./predictScore_testLIVE1_model_200.mat', {'score': y_predict})
